//sets all of player one to var allowing us to munipulate the DOM with them later
var button1 = document.querySelector('#ctr1');
var p1s =document.querySelector("#score1");
var score1 = 0;

//sets all of player two to var allowing us to munipulate the DOM with them later
var button2 = document.querySelector('#ctr2');
var p2s =document.querySelector("#score2");
var score2 = 0;

//selects var reset btn 
